    ...
    <section className="py-12 sm:py-16 md:py-20 bg-background">
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
        <div className="text-center mb-12 sm:mb-16">
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-4 sm:mb-6 px-4">{t("services.title")}</h2>
          <p className="text-base sm:text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto px-4">{t("services.subtitle")}</p>
        </div>
            ...
            return (
              ...
              >
                ...
                <CardHeader className="relative z-10">
                  ...
                  <CardTitle className="text-xl font-semibold">{t(service.titleKey)}</CardTitle>
                </CardHeader>
                <CardContent className="relative z-10">
                  <CardDescription className="text-muted-foreground mb-4 leading-relaxed">
                    {t(service.descriptionKey)}
                  </CardDescription>
                  <Button asChild variant="info" className="relative z-10 group/btn">
        ...
        <div className="text-center mt-12">
          <Button
            asChild
            size="lg"
            className="bg-primary hover:bg-primary/90 text-primary-foreground shadow-glow hover:scale-105 transition-all"
          >
            <Link to="/diensten">{t("services.cta")}</Link>
          </Button>
        </div>
      </div>
    </section>
